		...
		return(
			<div className="bg-blue-200 w-screen h-screen">
				<div className="px-10 top-10 fixed">
					...
					<Link className="px-20 rounded-lg py-5 bg-gray-100 shadow-lg hover:bg-gray-200 hover:py-6 top-60 right-5 relative text-gray-500 hover:text-gray-600 font-semibold" to="/simmodel" state={{new:false}}>Edit your NNet</Link>
					<Link className="px-20 rounded-lg py-5 bg-cyan-600 shadow-lg hover:bg-cyan-500 hover:py-6 relative top-40 right-72 text-white font-semibold" to="/simmodel" state={{new:true}}>Create Your neural Network</Link>
				</div>
